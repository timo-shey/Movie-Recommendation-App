...
public class LoggingAspect {
     ...
     */
    @Before("execution (* com.example.moviesearchapplication.service.*.*(..))")
     ...
     * @param joinPoint: has the details of the method being executed
     */
    @AfterReturning("execution (* com.example.moviesearchapplication.service.*.*(..))")
     ...
     * @param joinPoint: has the details of the method being executed
     */
    @AfterReturning("execution (* com.example.moviesearchapplication.repository.*.save(..))")
